...
TEST(Historical, Historical_set_order) {
	...
	ResearchOptions researchOptions(OrderTime::cronologicalOrder, OrderOptions::all, QString(""), QDate(18, 1, 1),
	                                QDate::currentDate());
...
TEST(Historical, Historical_get_total) {
	...
	ResearchOptions researchOptions(OrderTime::cronologicalOrder, OrderOptions::credits, QString(""), QDate(18, 1, 1),
	                                QDate::currentDate());
	historical1.setOrder(researchOptions);
