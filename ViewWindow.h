...
class Ui_MainWindow {
 public:
  ...
  void setupUi(QMainWindow *MainWindow) {
    ...
    comboBox_investmentType = new QComboBox(tab_5);
    ...
    comboBox_entity = new QComboBox(tab_5);
    ...
    label_34 = new QLabel(formWidget_stock);
    ...
    label_44 = new QLabel(formWidget_bond);
    label_44->setObjectName(QStringLiteral("label_44"));
    formLayout_6->setWidget(4, QFormLayout::LabelRole, label_44);
    ...
    QObject::connect(lineEdit_investmentAmount, SIGNAL(textChanged(
                                                           const QString &)), MainWindow, SLOT(lineInvestmentEdited(
                                                                                                   const QString &)));
    QObject::connect(comboBox_monthsNumber,
  ...
  void retranslateUi(QMainWindow *MainWindow) {
    ...
    radioButton_cronologicalOrderReverse->setText(QApplication::translate("MainWindow",
                                                                          "Dal pi\303\271 recente",
                                                                          Q_NULLPTR));
    ...
    comboBox_options->insertItems(0,
                                  QStringList() << QApplication::translate("MainWindow", "Tutto", Q_NULLPTR)
    ...
    comboBox_investmentType->insertItems(0,
                                         QStringList() << QApplication::translate("MainWindow", "Azione", Q_NULLPTR)
    ...
    label_31->setText(QApplication::translate("MainWindow", "Costo per azione: ", Q_NULLPTR));
    ...
    comboBox_monthsNumber->insertItems(0,
                                       QStringList() << QApplication::translate("MainWindow", "3", Q_NULLPTR)
